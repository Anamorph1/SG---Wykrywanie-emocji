iso226=function(phon,fl,fu,n) {
  # reference frequencies
  f_r = c(20, 25, 31.5, 40, 50, 63, 80, 100, 125, 160, 200, 250, 315, 400, 
          500, 630, 800, 1000, 1250, 1600, 2000, 2500, 3150, 4000, 5000, 
          6300, 8000, 10000, 12500)
  
  # exponent of loudness perception
  alpha_f = c(0.532, 0.506, 0.480, 0.455, 0.432, 0.409, 0.387,
  ...
  L_U = c(-31.6, -27.2, -23.0, -19.1, -15.9, -13.0, -10.3, -8.1,
          -6.2, -4.5, -3.1, -2.0, -1.1, -0.4, 0.0, 0.3, 0.5, 0.0, -2.7,
          -4.1, -1.0, 1.7, 2.5, 1.2, -2.1, -7.1, -11.2, -10.7, -3.1)
  
  # threshold of hearing
  T_f = c(78.5, 68.7, 59.5, 51.1, 44.0, 37.5, 31.5, 26.5, 22.1, 17.9,
          14.4, 11.4, 8.6, 6.2, 4.4, 3.0, 2.2, 2.4, 3.5, 1.7, -1.3, -4.2,
          -6.0, -5.4, -1.5, 6.0, 12.6, 13.9, 12.3)
  
  # calculate SPL
  A_f = 0.00447*((10^(0.025*phon))-1.15)+((0.4*(10^(((T_f+L_U)/10)-9)))^alpha_f)
  spl_r = ((10/alpha_f)*log10(A_f)) - L_U + 94
  
  # interpolate
  return(spline(f_r,spl_r,n,xmin = fl,xmax = fu,method = 'natural')$y)
}
